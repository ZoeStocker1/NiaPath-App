  ...
  public: {
    Tables: {
      ...
      career_interests: {
        ...
        Relationships: [
          {
            foreignKeyName: "career_interests_career_id_fkey"
            columns: ["career_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "career_interests_interest_id_fkey"
            columns: ["interest_id"]
            isOneToOne: false
      ...
      careers: {
        Row: {
          ...
          id: string
          labor_market_score_kenya: number | null
          title: string
        }
        Insert: {
          description?: string | null
      ...
      degree_careers: {
        ...
        Relationships: [
          {
            foreignKeyName: "degree_careers_career_id_fkey"
            columns: ["career_id"]
            isOneToOne: false
            referencedRelation: "careers"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "degree_careers_degree_id_fkey"
            columns: ["degree_id"]
            isOneToOne: false
